...
def upgrade() -> None:
    ...
    if not inspector.has_table("simulation_evidence"):
        op.create_table(
            "simulation_evidence",
    ...
    if not inspector.has_table("simulation_evidence_links"):
        op.create_table(
...
def downgrade() -> None:
    ...
    if inspector.has_table("simulation_evidence_links"):
        op.drop_table("simulation_evidence_links")
    if inspector.has_table("simulation_evidence"):
